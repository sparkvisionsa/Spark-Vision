...
export const content = {
  ...
  ar: {
    ...
    video: {
      header:
        "في سبارك فيجن، نطمح إلى أن نكون الوجهة الأولى للابتكار التقني، حيث تتحول الأفكار الجريئة إلى حلول برمجية ذكية تُحدث أثرًا مستدامًا، وتمنح عملاءنا ميزة تنافسية في العصر الرقمي.",
    },
    about: {
      title: "من نحن",
      description:
