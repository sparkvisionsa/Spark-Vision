...
const copy = {
  en: {
    ...
    description:
      "A specialized application to inspect, evaluate, and document the condition of assets on-site. This product is currently under development and will be available soon.",
    comingSoon: "Coming Soon",
    features: [
      "On-site asset condition assessment",
  ...
  ar: {
    ...
    description:
      "تطبيق متخصص لمعاينة وتقييم وتوثيق حالة الأصول ميدانيًا بشكل دقيق ومنظم. هذا المنتج قيد التطوير حاليًا وسيتوفر قريبًا.",
    comingSoon: "قريبًا",
    features: [
      "تقييم حالة الأصول ميدانيًا",
      "توثيق بالصور والفيديو",
      "قوائم فحص معيارية",
      "تقارير معاينة تلقائية",
    ],
    backToHub: "العودة إلى فاليو تك",
  },
} as const;

export default function AssetInspectionSection() {
  ...
  return (
    <div className="flex items-center justify-center px-4 py-10 text-center">
      <div className="max-w-lg space-y-6 rounded-3xl border border-slate-200/80 bg-white/80 p-8 shadow-sm backdrop-blur-sm">
        ...
        <div className={`text-${isArabic ? "right" : "left"} space-y-2 rounded-2xl bg-orange-50/60 p-4`}>
