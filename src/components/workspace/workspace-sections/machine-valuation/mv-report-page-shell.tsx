...
export function MvReportPageShell({
  ...
  if (variant === "cover") {
    return (
      ...
      >
        ...
        <div className="relative z-[1] flex h-[297mm] flex-col px-[4mm] pb-[7mm] pt-[9mm]">
          <div
          ...
          <footer className="relative z-[1] mt-auto border-t border-[#0C447C]/12 bg-white/88 px-2 py-3 text-[9px] font-semibold leading-relaxed text-slate-950 backdrop-blur-[2px]">
  ...
  return (
    ...
    >
      <header className="relative z-[1] shrink-0 border-b-2 border-[#0C447C]/90 bg-gradient-to-l from-[#f6f9fc] via-white to-[#eef6fb] px-[3mm] pb-2 pt-3">
      ...
      <div className={cn("relative z-[1] min-h-0 flex-1 px-[3mm] py-3 text-right", land && "py-2")}>{children}</div>

      <footer className="relative z-[1] mt-auto shrink-0 border-t border-slate-200/90 bg-gradient-to-b from-[#f8fafc] to-[#eef2f7] px-[3mm] py-2">
        <div className="flex flex-wrap justify-center gap-x-3 gap-y-0.5 text-center text-[8px] font-semibold leading-relaxed text-slate-950">
          {footerLines.length > 0 ? (
