...
/** رسم صفحات PDF المرفوعة — دقة أعلى لمرفق 1 في التقرير النهائي */
const PDF_UPLOAD_RENDER_SCALE = 2.4;
const PDF_UPLOAD_MAX_PAGE_PIXELS = 20_000_000;
/** صفحات PDF تُرسم على دفعات متزامنة (كل دفعة = حتى N صفحة) */
const PDF_PARALLEL_PAGES = 8;
/** جودة JPEG لصفحات PDF المستخرجة */
const PDF_PAGE_EXPORT_JPEG_QUALITY = 0.92;
