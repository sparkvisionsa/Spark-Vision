...
/**
 * رسم صفحات PDF المرفوعة — هدف ~320 DPI (72×4.5) لأقصى وضوح في الطباعة وWord.
 */
const PDF_UPLOAD_RENDER_SCALE = 4.5;
/** سقف ذاكرة معقول لصفحة واحدة */
const PDF_UPLOAD_MAX_PAGE_PIXELS = 56_000_000;
/** عند الدقة العالية نقلّل التوازي لتفادي نفاد ذاكرة المتصفح */
const PDF_PARALLEL_PAGES = 2;
/** JPEG شبه-بدون-فقدان للنصوص والأرقام */
const PDF_PAGE_EXPORT_JPEG_QUALITY = 0.985;
...
const EXCEL_IMAGE_CONCURRENCY = 3;
const EXCEL_AUTO_IMAGE_RENDER_SCALE = 3.6;
const EXCEL_AUTO_IMAGE_JPEG_QUALITY = 0.97;
...
/** حفظ صور Excel مباشرة كـ JPEG عالي الوضوح للتقرير المطبوع. */
const EXCEL_PDF_COMMIT_RENDER_SCALE = 4.0;
const EXCEL_PDF_COMMIT_JPEG_QUALITY = 0.98;
/**
