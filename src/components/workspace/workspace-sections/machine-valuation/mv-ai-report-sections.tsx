...
const TOPIC_RULES: TopicRule[] = [
  ...
  { topic: "compliance", patterns: [/الامتثال/, /الالتزام بمعايير/, /معايير التقييم/, /\bcompliance\b/i, /\bivs\b/, /international valuation standards/i] },
  ...
  { topic: "intendedUsers", patterns: [/مستخدمين مقصودين/, /من يجوز له استخدام/, /other intended users/i, /intended users/i] },
  ...
  { topic: "intendedUse", patterns: [/الاستخدام المقصود/, /الغرض من استخدام التقرير/, /intended use/i] },
  { topic: "valuationBasis", patterns: [/أساس القيمة/, /basis of value/i] },
  { topic: "valuePremise", patterns: [/فرضية القيمة/, /premise of value/i] },
  { topic: "useRestriction", patterns: [/القيود على استخدام/, /قيود استخدام التقرير/, /restrictions? on use/i] },
  { topic: "externalSpecialists", patterns: [/الاستعانة بأخصائيين/, /external specialists?/i] },
  { topic: "esg", patterns: [/البيئية والاجتماعية والحوكمة/, /العوامل البيئية والاجتماعية/, /\besg\b/i] },
