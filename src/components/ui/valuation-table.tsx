...
export function EditTransactionModal({
  ...
  const fields: {
    ...
    { key: "assignmentDate", labelKey: "assignmentDateLabel", type: "date" },
    {
      ...
      optionLabels: isRtl
        ? [
            ...
            "توزيع تركه",
            "البيع القسري",
            "معرفة القيمة السوقية",
            "معرفة القيمة الإيجارية",
            "التصفية",
            "أغراض إستثمارية",
            "التعويض",
          ]
    ...
    { key: "intendedUse", labelKey: "intendedUseLabel", type: "text" },
    {
      ...
      optionLabels: isRtl
        ? [
            ...
            "القيمة التكاملية",
            "الايجار السوقي",
            "القيمة السوقية / قيمة الايجار السوقي",
            "القيمة العادلة",
            "الإدراج في القوائم المالية",
          ]
        : [
            "Market Value",
            "Investment Value",
    ...
    { key: "clientId", labelKey: "clientIdLabel", type: "text" },
    {
      ...
      options: ["1", "3"],
      optionLabels: isRtl
        ? ["تقييم العقارات", "تقييم الآلات والمعدات"]
        : ["Real Estate Valuation", "Machinery & Equipment Valuation"],
    },
    {
      key: "priority",
